...
<div class="content">
    ...
    <header>
      <div class="container">
          ...
          <!-- Pretraga po mestu (klik na dugme pokreće filter) -->
          <form id="searchForm" class="d-flex justify-content-center mt-3" role="search">
              <input id="searchInput" class="form-control"
                     type="search"
                     placeholder="Unesi mesto (npr. Vračar, Centar, Telep...)"
                     aria-label="Search"
              ...
              <button id="resetBtn" class="btn btn-primary ms-2" type="button">
                  Prikaži sve
              </button>
          </form>
    ...
    <div class="property-card" data-bs-toggle="modal" data-bs-target="#modal9">
        ...
        <img src="https://www.parkpalace.rs/wp-content/uploads/2023/02/PentHouse-Stanovi-Kragujevac-03.webp">
        <div class="property-info">
